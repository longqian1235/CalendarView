...
public class MaterialCalendarView extends ViewGroup {
    ...
    private OnDateFocusListener focusListener;
...
//        addView(topbar, new LayoutParams(1));
    ...
    /**
     * Sets the listener to be notified upon focus on dates.
     *
     * @param focusListener thing to be notified
     */
    public void setOnDateFocusListener(OnDateFocusListener focusListener) {
    ...
    /**
     * Call by {@link CalendarPagerView} to indicate that a day is focused and we should handle it
     *
     * @param dayView
     */
    protected void onDateFocus(final DayView dayView,boolean isFocus) {
        if (focusListener != null) {
            focusListener.onDateFocus(MaterialCalendarView.this, dayView.getDate(),isFocus);
        }
    }
